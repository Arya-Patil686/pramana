...
export default function CertificatePage() {
  ...
  const episode = EPISODES.find((e) => e.id === certificate.episodeId);
            ...
            <div className="panel bezel mt-8">
              ...
              <div className="border-t border-border-subtle px-3.5 py-3">
                <p className="text-2xs leading-relaxed text-text-quaternary">
                  In the deployed pipeline each pre-image is the granule itself:
                  the TROPOMI asset id and acquisition timestamp, the exact FIRMS
                  query and its response body, the wind-field slice, the station
                  CSV. In this demonstration build the pre-image is the declared
                  descriptor shown above, so the tree is reproducible from what
